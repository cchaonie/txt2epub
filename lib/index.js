...
var cwd = process.cwd();
var moduleDirPath = path_1["default"].dirname(__filename);
var filePath = "".concat(sourceName, ".txt");
var fileOutPath = "".concat(targetFolder, "/").concat(targetName);
var pageTemplatePath = path_1["default"].resolve(moduleDirPath, '../templates/page.html');
var sectionTemplatePath = path_1["default"].resolve(moduleDirPath, '../templates/section.html');
...
function run() {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, parseContent()];
                case 1:
                    _a.sent();
                    console.log('Parse content successfully');
                    return [4 /*yield*/, createFolder()];
                case 2:
                    _a.sent();
